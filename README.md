...
# 📖 ruby-react App <a name="about-project"></a>

**ruby-react App** The ruby-react app displays a random greeting using react and redux in a rails app that involves everything, the api is generated using the same app trought rails.

## 🗝️ Key Features <a name="key-features"></a>

- [x] Displayed data from rails API
- [x] Uses react into rails
- [x] Uses react router and redux
...
Using SSH-key:
```
git clone git@github.com:mrcbq/ruby-react-app.git
```

Using HTTPS:

```
git clone https://github.com/mrcbq/ruby-react-app
```
...
2. Navigate to the directory where you have cloned or downloaded the ruby-react App repository.
...
1. Once the setup is complete, ensure you are still in the directory containing the ruby-react App files.
